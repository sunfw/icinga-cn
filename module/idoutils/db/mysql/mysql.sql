...
CREATE TABLE IF NOT EXISTS icinga_acknowledgements (
  ...
  author_name varchar(64) character set utf8  default '',
  comment_data TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_commands (
  ...
  object_id bigint unsigned default 0,
  command_line TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_configfiles (
  ...
  configfile_path varchar(255) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_configfilevariables (
  ...
  varname varchar(64) character set utf8  default '',
  varvalue TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_conninfo (
  ...
  instance_id bigint unsigned default 0,
  agent_name varchar(32) character set utf8  default '',
  agent_version varchar(16) character set utf8  default '',
  disposition varchar(16) character set utf8  default '',
  connect_source varchar(16) character set utf8  default '',
  connect_type varchar(16) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_contactgroups (
  ...
  alias TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_contactnotificationmethods (
  ...
  command_args TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_contacts (
  ...
  config_type smallint default 0,
  contact_object_id bigint unsigned default 0,
  alias varchar(64) character set utf8  default '',
  email_address varchar(255) character set utf8  default '',
  pager_address varchar(64) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_contact_notificationcommands (
  ...
  command_object_id bigint unsigned default 0,
  command_args varchar(255) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_customvariables (
  ...
  varname varchar(255) character set utf8  default '',
  varvalue TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_dbversion (
  ...
  name varchar(10) character set utf8  default '',
  version varchar(10) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_eventhandlers (
  ...
  output TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_externalcommands (
  ...
  command_name varchar(128) character set utf8  default '',
  command_args TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_hostchecks (
  ...
  output TEXT character set utf8  default '',
  long_output TEXT  default '',
  perfdata TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_hosts (
  ...
  host_object_id bigint unsigned default 0,
  alias varchar(64) character set utf8  default '',
  display_name varchar(255) character set utf8 collate utf8_general_ci  default '',
  address varchar(128) character set utf8  default '',
  address6 varchar(128) character set utf8  default '',
  check_command_object_id bigint unsigned default 0,
  check_command_args TEXT character set utf8  default '',
  eventhandler_command_object_id bigint unsigned default 0,
  eventhandler_command_args TEXT character set utf8  default '',
  notification_timeperiod_object_id bigint unsigned default 0,
  check_timeperiod_object_id bigint unsigned default 0,
  failure_prediction_options varchar(128) character set utf8  default '',
  ...
  notes TEXT character set utf8  default '',
  notes_url TEXT character set utf8  default '',
  action_url TEXT character set utf8  default '',
  icon_image TEXT character set utf8  default '',
  icon_image_alt TEXT character set utf8  default '',
  vrml_image TEXT character set utf8  default '',
  statusmap_image TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_hoststatus (
  ...
  obsess_over_host smallint default 0,
  modified_host_attributes  int default 0,
  event_handler TEXT character set utf8  default '',
  check_command TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_instances (
  ...
  instance_name varchar(64) character set utf8  default '',
  instance_description varchar(128) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_logentries (
  ...
  logentry_data TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_objects (
  ...
  name1 varchar(128) character set utf8 collate utf8_general_ci  default '',
  name2 varchar(128) character set utf8 collate utf8_general_ci default NULL,
...
CREATE TABLE IF NOT EXISTS icinga_processevents (
  ...
  program_name varchar(16) character set utf8  default '',
  program_version varchar(20) character set utf8  default '',
  program_date varchar(10) character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_programstatus (
  ...
  modified_host_attributes  int default 0,
  modified_service_attributes  int default 0,
  global_host_event_handler TEXT character set utf8  default '',
  global_service_event_handler TEXT character set utf8  default '',
...
CREATE TABLE IF NOT EXISTS icinga_services (
  ...
  notification_timeperiod_object_id bigint unsigned default 0,
  check_timeperiod_object_id bigint unsigned default 0,
  failure_prediction_options varchar(64) character set utf8  default '',
  check_interval double  default '0',
  retry_interval double  default '0',
  max_check_attempts smallint default 0,
  first_notification_delay double  default '0',
