...
int display_stats(void) {
	...
	if (event_profiling_enabled) {
		printf("\n\n事件配置文件数据:\t\t总计花费秒数 / 事件数 / 平均每个事件的时间 / 事件/秒 \n");
		printf("----------------------------------------------------\n");
