...
int main(void) {
	...
	document_header(CGI_ID, TRUE, "状态 WML");
...
void display_index(void) {
	...
	printf("<card id='card1' title='%sWAP接口'>\n", PROGRAM_NAME);
	printf("<p align='center' mode='nowrap'>\n");

	printf("<b>%s</b><br/><b>WAP接口</b><br/>\n", PROGRAM_NAME);

	printf("<b><anchor title='快速查看'>快速查看状态<go href='%s'><postfield name='style' value='quickstats'/></go></anchor></b><br/>\n", STATUSWML_CGI);

	printf("<b><anchor title='状态汇总'>状态汇总<go href='%s'><postfield name='hostgroup' value='all'/><postfield name='style' value='summary'/></go></anchor></b><br/>\n", STATUSWML_CGI);

	printf("<b><anchor title='状态概要'>状态概要<go href='%s'><postfield name='hostgroup' value='all'/><postfield name='style' value='overview'/></go></anchor></b><br/>\n", STATUSWML_CGI);
	...
	printf("<b><anchor title='网络工具'>工具<go href='#card2'/></anchor></b><br/>\n");

	printf("<b><anchor title='关于'>关于<go href='#card3'/></anchor></b><br/>\n");
	...
	/**** TOOLS SCREEN (CARD 2) ****/
	printf("<card id='card2' title='网络工具'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	...
	printf("<b><anchor title='查看主机'>查看主机<go href='#card4'/></anchor></b><br/>\n");
	printf("<b><anchor title='查看主机组'>查看主机组<go href='#card5'/></anchor></b><br/>\n");
	...
	/**** ABOUT SCREEN (CARD 3) ****/
	printf("<card id='card3' title='关于'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>About</b><br/>\n");
	printf("</p>\n");

	printf("<p align='center' mode='wrap'>\n");
	printf("<b>%s %s</b><br/><b>WAP接口</b><br/>\n", PROGRAM_NAME, PROGRAM_VERSION);
	printf("Copyright (C) 2001 Ethan Galstad<br/>\n");
	printf("egalstad@nagios.org<br/><br/>\n");
	printf("许可: <b>GPL</b><br/><br/>\n");
	printf("部分功能基于AskAround的无线网络工具<br/>\n");
	...
	printf("<card id='card4' title='查看主机'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>查看主机</b><br/>\n");
	printf("</p>\n");
	...
	printf("<card id='card5' title='查看主机组'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>查看主机组</b><br/>\n");
	printf("</p>\n");
...
void display_process(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='进程信息'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>进程信息</b><br/><br/>\n");

	/* check authorization */
	if (is_authorized_for_system_information(&current_authdata) == FALSE) {

		printf("<b>错误:未授权的进程信息!</b>\n");
		printf("</p>\n");
		printf("</card>\n");
		return;
	}
	...
	if (execute_service_checks == TRUE)
		...
		printf("<b>禁用检查执行</b><br/>\n");

	printf("<br/>\n");
	printf("<b><anchor title='进程命令'>进程命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	printf("<card id='card2' title='进程命令'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>进程命令</b><br/>\n");

	if (enable_notifications == FALSE)
		printf("<b><anchor title='启用通知'>启用通知<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, CMD_ENABLE_NOTIFICATIONS, CMDMODE_COMMIT);
	else
		printf("<b><anchor title='禁用通知'>禁用通知<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, CMD_DISABLE_NOTIFICATIONS, CMDMODE_COMMIT);

	if (execute_service_checks == FALSE)
		printf("<b><anchor title='启用检查执行'>启用检查执行<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, CMD_START_EXECUTING_SVC_CHECKS, CMDMODE_COMMIT);
	else
		printf("<b><anchor title='禁用检查执行'>禁用检查执行<go href='%s' method='post'><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, CMD_STOP_EXECUTING_SVC_CHECKS, CMDMODE_COMMIT);
...
void display_quick_stats(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='快速查看状态'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>快速查看状态</b><br/>\n");
	printf("</p>\n");
...
void display_hostgroup_overview(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='状态概概述>\n");
	printf("<p align='center' mode='nowrap'>\n");

	printf("<b><anchor title='状态概述'>状态概述<go href='%s' method='post'><postfield name='hostgroup' value='%s'/><postfield name='style' value='summary'/></go></anchor></b><br/><br/>\n", STATUSWML_CGI, escape_string(hostgroup_name));
	...
	if (show_all_hostgroups == FALSE)
		printf("<b><anchor title='查看所有主机组'>查看所有主机组<go href='%s' method='post'><postfield name='hostgroup' value='all'/><postfield name='style' value='overview'/></go></anchor></b>\n", STATUSWML_CGI);
...
void display_hostgroup_summary(void) {
	...
	for (temp_hostgroup = hostgroup_list; temp_hostgroup != NULL; temp_hostgroup = temp_hostgroup->next) {
		...
		printf("<tr><td>主机:</td><td>");
		found = 0;
		if (hosts_unreachable > 0) {
			printf("%d 不可达", hosts_unreachable);
			found = 1;
		}
		if (hosts_down > 0) {
			printf("%s%d 宕机", (found == 1) ? ", " : "", hosts_down);
			found = 1;
		}
		if (hosts_pending > 0) {
			printf("%s%d 未决", (found == 1) ? ", " : "", hosts_pending);
			found = 1;
		}
		printf("%s%d 运行", (found == 1) ? ", " : "", hosts_up);
		printf("</td></tr>\n");
		printf("<tr><td>服务:</td><td>");
		found = 0;
		if (services_critical > 0) {
			printf("%d 严重", services_critical);
			found = 1;
		}
		if (services_warning > 0) {
			printf("%s%d 警报", (found == 1) ? ", " : "", services_warning);
			found = 1;
		}
		if (services_unknown > 0) {
			printf("%s%d 未知", (found == 1) ? ", " : "", services_unknown);
			found = 1;
		}
		if (services_pending > 0) {
			printf("%s%d 未决", (found == 1) ? ", " : "", services_pending);
			found = 1;
		}
		printf("%s%d 正常", (found == 1) ? ", " : "", services_ok);
		printf("</td></tr>\n");
	...
	if (show_all_hostgroups == FALSE)
		printf("<b><anchor title='查看所有主机组'>查看所有主机组<go href='%s' method='post'><postfield name='hostgroup' value='all'/><postfield name='style' value='summary'/></go></anchor></b>\n", STATUSWML_CGI);
...
void display_host(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='主机状态'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>主机 '%s'</b><br/>\n", host_name);
	...
	printf("</table>\n");
	printf("<br/>\n");
	printf("<b><anchor title='查看服务'>查看服务<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='style' value='servicedetail'/></go></anchor></b>\n", STATUSWML_CGI, escape_string(host_name));
	printf("<b><anchor title='主机命令'>主机命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	/**** COMMANDS SCREEN (CARD 2) ****/
	printf("<card id='card2' title='主机命令'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>主机命令</b><br/>\n");

	printf("<b><anchor title='Ping 主机'>Ping 主机<go href='%s' method='post'><postfield name='ping' value='%s'/></go></anchor></b>\n", STATUSWML_CGI, temp_host->address);
	printf("<b><anchor title='Ping6 主机'>Ping6 主机<go href='%s' method='post'><postfield name='ping6' value='%s'/></go></anchor></b>\n", STATUSWML_CGI, temp_host->address6);
	...
	if (temp_hoststatus->status != HOST_UP && temp_hoststatus->status != HOST_PENDING)
		printf("<b><anchor title='确认故障'>确认故障<go href='#card3'/></anchor></b>\n");

	if (temp_hoststatus->checks_enabled == FALSE)
		printf("<b><anchor title='启用主机检查'>启用主机检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_ENABLE_HOST_CHECK, CMDMODE_COMMIT);
	else
		printf("<b><anchor title='禁用主机检查'>禁用主机检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_DISABLE_HOST_CHECK, CMDMODE_COMMIT);

	if (temp_hoststatus->notifications_enabled == FALSE)
		printf("<b><anchor title='启用主机通知'>启用主机通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_ENABLE_HOST_NOTIFICATIONS, CMDMODE_COMMIT);
	else
		printf("<b><anchor title='禁用主机通知'>禁用主机通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_DISABLE_HOST_NOTIFICATIONS, CMDMODE_COMMIT);


	printf("<b><anchor title='启用所有服务检查'>启用所有服务检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_ENABLE_HOST_SVC_CHECKS, CMDMODE_COMMIT);

	printf("<b><anchor title='禁用所有服务检查'>禁用所有服务检查<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_DISABLE_HOST_SVC_CHECKS, CMDMODE_COMMIT);

	printf("<b><anchor title='启用所有通知'>启用所有通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_ENABLE_HOST_SVC_NOTIFICATIONS, CMDMODE_COMMIT);

	printf("<b><anchor title='禁用所有通知'>禁用所有通知<go href='%s' method='post'><postfield name='host' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", CMD_CGI, escape_string(host_name), CMD_DISABLE_HOST_SVC_NOTIFICATIONS, CMDMODE_COMMIT);
	...
	printf("<card id='card3' title='确认故障'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>确认故障</b><br/>\n");
	printf("</p>\n");
	...
	printf("<b>注释:</b><br/>\n");
	printf("<input name='comment' value='通过WAP确认'/>\n");
...
void display_host_services(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='主机服务'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>主机 <anchor title='%s'>", url_encode(host_name));
	printf("'%s'<go href='%s' method='post'><postfield name='host' value='%s'/></go></anchor> 服务</b><br/>\n", host_name, STATUSWML_CGI, escape_string(host_name));
...
void display_service(void) {
	...
	/**** MAIN SCREEN (CARD 1) ****/
	printf("<card id='card1' title='服务状态'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>主机'%s'上的服务'%s'</b><br/>\n", host_name, service_desc);
	...
	get_time_breakdown((unsigned long)t, &days, &hours, &minutes, &seconds);
	snprintf(state_duration, sizeof(state_duration) - 1, "%2d天%2d时%2d分%2d秒%s", days, hours, minutes, seconds, (temp_servicestatus->last_state_change == (time_t)0) ? "+" : "");
	printf("<tr><td>持续时间:</td><td>%s</td></tr>\n", state_duration);
	...
	printf("</table>\n");
	printf("<br/>\n");
	printf("<b><anchor title='查看主机'>查看主机<go href='%s' method='post'><postfield name='host' value='%s'/></go></anchor></b>\n", STATUSWML_CGI, escape_string(host_name));
	printf("<b><anchor title='服务命令'>服务命令<go href='#card2'/></anchor></b>\n");
	printf("</p>\n");
	...
	/**** COMMANDS SCREEN (CARD 2) ****/
	printf("<card id='card2' title='服务命令'>\n");
	printf("<p align='center' mode='nowrap'>\n");
	printf("<b>服务命令</b><br/>\n");
	...
	if (temp_servicestatus->checks_enabled == FALSE) {
		printf("<b><anchor title='启用检查'>启用检查<go href='%s' method='post'><postfield name='host' value='%s'/>", CMD_CGI, escape_string(host_name));
		...
		printf("<b><anchor title='禁用检查'>禁用检查<go href='%s' method='post'><postfield name='host' value='%s'/>", CMD_CGI, escape_string(host_name));
		printf("<postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", escape_string(service_desc), CMD_DISABLE_SVC_CHECK, CMDMODE_COMMIT);

		printf("<b><anchor title='安排立即检查'>安排立即检查<go href='%s' method='post'><postfield name='host' value='%s'/>", CMD_CGI, escape_string(host_name));
	...
	if (temp_servicestatus->notifications_enabled == FALSE) {
		printf("<b><anchor title='启用通知'>启用通知<go href='%s' method='post'><postfield name='host' value='%s'/>", CMD_CGI, escape_string(host_name));
		printf("<postfield name='service' value='%s'/><postfield name='cmd_typ' value='%d'/><postfield name='cmd_mod' value='%d'/><postfield name='content' value='wml'/></go></anchor></b><br/>\n", escape_string(service_desc), CMD_ENABLE_SVC_NOTIFICATIONS, CMDMODE_COMMIT);
	} else {
		printf("<b><anchor title='禁用通知'>禁用通知<go href='%s' method='post'><postfield name='host' value='%s'/>", CMD_CGI, escape_string(host_name));
...
void display_ping(void) {
	...
	if (!strcmp(ping_address, "")) {
		...
		printf("<p align='center' mode='nowrap'>\n");
		printf("<b>Ping 主机</b><br/>\n");
		printf("</p>\n");

		printf("<p align='center' mode='wrap'>\n");
		printf("<b>主机名称/地址:</b><br/>\n");
		...
		printf("<p align='center' mode='nowrap'>\n");
		printf("<b>%s的Ping结果:</b><br/>\n", ping_address);
		printf("</p>\n");

		printf("<p mode='nowrap'>\n");

		if (ping_syntax == NULL)
			printf("ping_syntax 在CGI配置文件中为空!\n");
